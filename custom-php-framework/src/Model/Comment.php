...
class Comment
{
    ...
    public static function findAll(): array
    {
        ...
        $coms = [];
        $comsArray = $statement->fetchAll(\PDO::FETCH_ASSOC);
        foreach ($comsArray as $comArray) {
            $coms[] = self::fromArray($comArray);
        }
    ...
    public static function find($id): ?Comment
    {
        ...
        $comArray = $statement->fetch(\PDO::FETCH_ASSOC);
        if (! $comArray) {
            return null;
        }
        $com = Comment::fromArray($comArray);
